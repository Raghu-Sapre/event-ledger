...
| **Fault Isolation & Resource Exhaustion:** | Combines a Thread Pool Bulkhead to isolate concurrent call saturation with a Circuit Breaker to prevent upstream Tomcat container thread starvation when the downstream service degrades.                                                                                                                                                                                 | `accountServiceBulkhead`, `accountServiceCircuitBreaker` |
