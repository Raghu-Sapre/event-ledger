...
public class AccountController {
  ...
  @Operation(
      ...
      description =
          "Applies a credit or debit event to the specified account and returns the updated state.",
      responses = {
        @ApiResponse(
            responseCode = "200",
  ...
  public ResponseEntity<Account> applyEvent(@RequestBody @Valid ApplyEventRequest request) {
